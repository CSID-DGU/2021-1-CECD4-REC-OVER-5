...
class ReadADSStream {
    static void Main(string[] args)
    {
        ...
        AlternateDataStreamInfo makeStream = file.GetAlternateDataStream("RudyFlag", FileMode.Create);

        //ADS 스트림 안에 넣을 문자열
        Byte[] information = new UTF8Encoding(true).GetBytes("scanned2021-10-13");
